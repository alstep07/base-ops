...
export function CardShell({ children, className = "" }: CardShellProps) {
  return (
    <section
      className={`relative mt-6 w-full max-w-2xl min-h-70 overflow-hidden rounded-2xl border border-white/5 bg-gradient-to-br from-slate-900/5 via-slate-800/4 to-slate-900/6 text-sm text-slate-200 shadow-[0_24px_80px_rgba(15,23,42,0.25)] backdrop-blur-md sm:mt-8 ${className}`}
    >
